...
if __name__ == '__main__':
    ...
    if version == "plotly":
        ...
        nodal_data_list = [
            NodalData('la', 'Los_Angeles', 'van', 'la', energy_type, 34.03, -118.25 ),
            NodalData('nyc', 'New_York', 'la', 'chi', energy_type, 40.71, -74 ),
            NodalData('to', 'Toronto', 'hou', 'chi', energy_type, 43.65, -79.38 ),
            NodalData('mtl', 'Montreal', 'to', 'mtl', energy_type, 45.50, -73.57 ),
            NodalData('van', 'Vancouver', 'mtl', 'bos', energy_type, 49.28, -123.12 ),
            NodalData('chi', 'Chicago', 'nyc', 'bos',energy_type,  41.88, -87.63 ),
            NodalData('bos', 'Boston', 'to', 'hou', energy_type, 42.36, -71.06 ),
            NodalData('hou', 'Houston', 'to', 'nyc', energy_type, 29.76, -95.37)
        ]
        nodes_dict = []
        edges_dict = []
