...
def plot(excelFileName, outputFileName, numberOfBuildings, UseLabelDict):
    BUILDINGSLIST = list(range(1, numberOfBuildings + 1))
    fig = displaySankey(excelFileName, UseLabelDict, BUILDINGSLIST)
    fig.show()
...
if __name__ == "__main__":
    ...
    plot(excelFileName, outputFileName, numberOfBuildings, UseLabelDict)
