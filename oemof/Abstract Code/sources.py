...
class PV(solph.Source):
    def __init__(self, label, buildingLabel, outputs, peripheral_losses, latitude, longitude,
                 pv_tilt, pv_azimuth, nominalPower, irradiance_global, irradiance_diffuse, temp_amb_pv, capacityMin,
        ...
        self.pv_electricity = np.minimum(self.pv_precalc(temp_amb_pv, data['pv_ira']/1000, nominalPower), capacityMax + base)
    ...
    # model according to Energy management algorithms description. D6.2 v1.0
    def pv_precalc(self, temp_amb, i_H_t, nominalPower, a1=17.23292, a2=0.451708, a3=22.706, a4=-0.062059,
                   a5=0.04277774, a6=9.692792, a7=-1.885868, a8=6.6):

        temp_cell = a1 + a2 * temp_amb + a3 * i_H_t
        pvPower = np.maximum(0, (a4*i_H_t + a5)*temp_cell+a6 * i_H_t+a7) * nominalPower / a8
        return pvPower
