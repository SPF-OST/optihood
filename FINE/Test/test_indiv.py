...
from getData_indiv import getData
import pandas as pd
import os
...
fig9, ax = fn.plotOperation(esM, 'HP1', 'building_1')
fig10, ax = fn.plotOperation(esM, 'HP1', 'building_2')
fig11, ax = fn.plotOperation(esM, 'HP2', 'building_1')
fig12, ax = fn.plotOperation(esM, 'HP2', 'building_2')
fig13, ax = fn.plotOperation(esM, 'HP3', 'building_1')
fig14, ax = fn.plotOperation(esM, 'HP3', 'building_2')
#fig88, ax = fn.plotOperation(esM, 'Battery1', 'building_1')
fig15, ax = fn.plotOperation(esM, 'Electricity grid', 'building_1', color='g')
fig16, ax = fn.plotOperation(esM, 'Electricity grid', 'building_2', color='g')
fig17, ax = fn.plotOperation(esM, 'Natural gas', 'building_1', color='g')
fig18, ax = fn.plotOperation(esM, 'Natural gas', 'building_2', color='g')
...
with pd.ExcelWriter("Resultats_indiv.xlsx") as writer:
